...
class SingleTunnelNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes):
        super(SingleTunnelNet, self).__init__()
        self.in_planes = 32
        width = [32, 64, 128, 256]
        ...
        self.base1 = nn.Sequential(
            ...
            self._make_layer(block, width[3], num_blocks[3], stride=2),
        )
        
        self.fc1 = nn.Linear(self.in_planes, num_classes)
...
def SingleTunnelNet18(num_class):
    return SingleTunnelNet(PreActBlock, [2,2,2,2], num_class)
